          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content "> 
              ...
              <div class="tab-pane row active" id="mproductos">  
                    ...
                    <div class="col-sm-12 text-center" style="padding: 0px;margin-bottom: 15px;">  
                        <input style="max-width: 250px;margin: 0 auto;" class="form-control" type="date" id="buscador" placeholder="Buscar..."> 
                        <button  style="max-width: 150px;margin-top: 15px;" class="form-cotnrol btn btn-danger btn-sm">Buscar</button>
                    </div> 
